...
public class OtherViews extends AppCompatActivity {
    ListView viewlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Cursor tmptable = db.rawQuery("Select * from tblproduct where f_prodtype = 'Other'  order by f_prodname", null);
