...
public class FoodViews extends AppCompatActivity {
    ListView viewlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_views);

        SQLiteDatabase db = openOrCreateDatabase("dbaseprod", Context.MODE_PRIVATE,null);
        viewlist = findViewById(R.id.ListView);
        final Cursor tmptable = db.rawQuery("Select * from tblproduct where f_prodtype = 'Food'  order by f_prodname", null);
